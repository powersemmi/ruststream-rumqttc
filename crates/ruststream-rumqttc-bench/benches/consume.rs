...
#[library_benchmark]
#[bench::first(args = (app(1)), config = common::config_every(4_189, 1_000, 66, 1))]
#[bench::base(args = (app(MESSAGES)), config = common::config_every(4_189, 1_000, 66, MESSAGES))]
#[bench::twice(args = (app(2 * MESSAGES)), config = common::config_every(4_189, 1_000, 66, 2 * MESSAGES))]
