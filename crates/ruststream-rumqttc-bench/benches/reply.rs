...
#[library_benchmark]
#[bench::first(args = (app(1)), config = common::config_every(10_295, 1_000, 73, 1))]
#[bench::base(args = (app(MESSAGES)), config = common::config_every(10_295, 1_000, 73, MESSAGES))]
#[bench::twice(args = (app(2 * MESSAGES)), config = common::config_every(10_295, 1_000, 73, 2 * MESSAGES))]
